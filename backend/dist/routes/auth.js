...
// Get current user
router.get('/me', rateLimiter, verifyToken, async (req, res) => {
    try {
        if (!req.user) {
...
// Update user profile
router.put('/profile', rateLimiter, verifyToken, requireEmailVerified, async (req, res) => {
    try {
        if (!req.user) {
...
router.put('/updatepassword', rateLimiter, verifyToken, requireEmailVerified, async (req, res) => {
...
router.put('/updatedetails', rateLimiter, verifyToken, requireEmailVerified, async (req, res) => {
...
router.get('/logout', rateLimiter, verifyToken, async (req, res) => {
    try {
...
router.post('/refresh-token', rateLimiter, async (req, res) => {
