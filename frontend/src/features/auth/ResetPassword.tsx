...
export default function ResetPassword() {
  ...
  return (
    <AuthContainer>
      <h2 className="text-3xl font-bold mb-4 text-center bg-gradient-to-tr from-[#6C63FF] to-[#00CFFF] bg-clip-text text-transparent drop-shadow-lg">Reset Password</h2>
      ...
      <div className="mt-6 text-center text-xs text-gray-500 flex flex-col gap-1">
        <div>
          Back to <a href="/login" className="text-blue-600 underline transition-all hover:text-purple-600">Log in</a>
        </div>
